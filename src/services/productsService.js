...
export default class ProductsService {
  ...
  getProducts = (callbackSuccess, callbackError) => {
    const data = {
      url: `${process.env.REACT_APP_BASE_URL}${process.env.REACT_APP_GET_ALL_PRODUCTS}`,
  ...
  getProductById = ({ pid, callbackSuccess, callbackError }) => {
    const data = {
      url: `${process.env.REACT_APP_BASE_URL}${process.env.REACT_APP_GET_PRODUCT_BY_ID}${pid}`,
      config: getAuthHeaders(),
      callbackSuccess,
      callbackError,
    };
  ...
  createProduct = ({ body, callbackSuccess, callbackError }) => {
    const data = {
      url: `${process.env.REACT_APP_BASE_URL}${process.env.REACT_APP_CREATE_PRODUCT}`,
      body,
      config: getAuthHeaders(),
      callbackSuccess,
      callbackError,
  ...
  updateProduct = ({ pid, body, callbackSuccess, callbackError }) => {
    const data = {
      url: `${process.env.REACT_APP_BASE_URL}${process.env.REACT_APP_UPDATE_PRODUCT}${pid}`,
      body,
      config: getAuthHeaders(),
      callbackSuccess,
      callbackError,
  ...
  deleteProduct = ({ pid, callbackSuccess, callbackError }) => {
    const data = {
      url: `${process.env.REACT_APP_BASE_URL}${process.env.REACT_APP_DELETE_PRODUCT}${pid}`,
      config: getAuthHeaders(),
      callbackSuccess,
      callbackError,
    };
